...
export default function ImageCaption() {
    ...
    const [caption, setCaption] = useState(""); // To store the generated caption
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        setError(null);
        setCaption(""); // Reset caption before new request
        ...
        try {
            // Call Flask API for image captioning
            ...
            if (data.caption) {
                setCaption(data.caption); // Store the caption from the API
            } else {
                setCaption("No caption returned from the API.");
            }
        } catch (err) {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
                Upload an image and get a caption generated using huggingface transformers model running on local server.
            </p>
            ...
            {caption && (
                <div className="mt-4 bg-gray-100 dark:bg-gray-900 p-4 rounded-lg shadow">
                    ...
                    <p className="mt-2 text-gray-700 dark:text-gray-300">{caption}</p>
                </div>
            )}
        </div>
    );
